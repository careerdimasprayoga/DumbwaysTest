            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <form method="POST" action="<?=base_url('genre/action_add_genre');?>" class="form-horizontal">
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" name="genre" id="email_address_2" class="form-control" placeholder="Enter new Genre">
                                            </div>
                                        </div>
                                    </div>
                                </div>
